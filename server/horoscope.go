...
func (s *Server) GetHoroscope(ctx context.Context, in *horoscope.GetHoroscopeRequest) (*horoscope.GetHoroscopeResponse, error) {
	...
	return &horoscope.GetHoroscopeResponse{Text: s}, nil
}